...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (testCheck(currentPlayer)) {
			...
			throw new ChessException("Você não pode fazer uma jogada que te coloque em check");
		}
	...
	public ChessPiece replacePromotedPiece(String type) {
		if (promoted == null) {
			throw new IllegalStateException("Não há nenhuma peça para fazer a jogada PROMOÇÃO");
		}
		if (!type.equals("B") && !type.equals("C") && !type.equals("T") & !type.equals("A")) {
			return promoted;
		}
